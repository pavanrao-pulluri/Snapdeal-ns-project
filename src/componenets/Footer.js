  ...
  return (
    <div style={{ margin: "10px" }}>
      <div className="footer">
        <h1 className="ui center aligned container">our collections</h1>
        <p>
          <span className="footersubhead">Men:</span>
          ...
          / Blazer for Men / Sweater for Men
        </p>

        <p>
          <span className="footersubhead">Women:</span>
          ...
          Ethnic wear for Women / Western Dresses for Women / Leggings for Women
        </p>

        <p>
          <span className="footersubhead">Footwear:</span>
          Men's Footwear / Casual Shoes for Men / Formal Shoes for Men / Loafers
          for Men / Slippers for Men / Boots for Men / Sandals for Men /
          Footwear for Women / Heels for Women / Sandals for Women / Shoes for
          Women / Sandals for Women / Slippers for Women / Boots for Women /
          Jutti for Women / Sports Shoes for Women
        </p>
        <p>
          <span className="footersubhead">Home & Kitchen:</span>
          Wall Painting / Wall Stickers / Dream Catcher / Rangoli Designs /
          Clock / Wall Clock / Alarm Clock / Diya / Bean Bag / Laptop Table /
          Study Table / Wall Hanging / Ceiling Lights / Table Lamp / Hanging
          Lights / LED Bulbs / Torch Light / LED Lights / Flower Vase / Keychain
          / Rudraksha / Screwdriver
        </p>
        <p>
          <span className="footersubhead">Watch:</span>
          Watch For Men / Womens Watches / Smart Watch / Boys Watch / Girls
          Watch
        </p>
        <p>
          <span className="footersubhead">Home Furnishing:</span>
          Bed Sheet / Mosquito Net / Mattress / Curtains / Sofa Cover / Blanket
          / Pillow / Carpet / Apron / Quilt / Floor Mat / Towel / Pillow Cover
        </p>
        <p>
          <span className="footersubhead">Electronics:</span>
          Bluetooth Speakers / Headphones / Earphone / Ceiling Fan / Geysers /
          Trimmer / Hair Straightner / Hair Dryer / Water Purifier / Mixer
        ...
        <div>
          <span className="ui center aligned container">
            Copyright © 2023, Snapdeal Limited. All Rights Reserved
          </span>
        </div>
      </div>
    </div>
